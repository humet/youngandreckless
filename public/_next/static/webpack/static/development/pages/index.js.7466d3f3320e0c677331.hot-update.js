...
/* harmony import */ var _components_formErrors__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/formErrors */ "./components/formErrors.js");
...
function (_Component) {
  ...
  function Form(props) {
    ...
    _this.sendForm = _this.sendForm.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this));
    return _this;
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Form, [{
    ...
    value: function sendForm(event) {
      alert(event.readyState);

      if (this.readyState === 4) {
        var response = JSON.parse(this.response);

        if (response['success'] == true) {
          next_router__WEBPACK_IMPORTED_MODULE_9___default.a.push('/confirm');
        } else {
          this.setState({
            formErrors: {
    ...
    value: function handleButtonClick(e) {
      ...
      xhr.addEventListener("load", this.sendForm(event));
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("form", {
        ...
        __self: this
      }, "E-Mail Adresse:"), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("input", {
        className: "email",
        style: {
          padding: 10,
          marginBottom: 10
        ...
        __self: this
      }, "Hinweis: Mit Deiner Einwilligung best\xE4tigst du uns, Dich regelm\xE4\xDFig per E-Mail \xFCber Neuerungen und aktuelle Angebote von Young & Reckless informieren zu d\xFCrfen. Deine E-Mail Adresse wird nicht an Dritte weitergegeben. Eine Abmeldung ist jederzeit m\xF6glich. Die Datenschutzhinweise habe ich zur Kenntnis genommen."), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 100
        },
        __self: this
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_components_formErrors__WEBPACK_IMPORTED_MODULE_8__["default"], {
...
//# sourceMappingURL=index.js.7466d3f3320e0c677331.hot-update.js.map