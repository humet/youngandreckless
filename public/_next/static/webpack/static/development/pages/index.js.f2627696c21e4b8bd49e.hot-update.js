  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Form, [{
    ...
    value: function handleButtonClick(e) {
      ...
      xhr.addEventListener('load', function (e) {
        if (_this4.readyState === 4) {
          var response = JSON.parse(_this4.response);

          if (response['success'] == true) {//Router.push('/confirm')
          } else {//this.setState({formErrors: {email: response['errorMessage']}})
            }
        }
      });
...
//# sourceMappingURL=index.js.f2627696c21e4b8bd49e.hot-update.js.map